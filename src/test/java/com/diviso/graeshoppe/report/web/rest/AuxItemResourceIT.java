...
/**
 * Integration tests for the {@link AuxItemResource} REST controller.
 */
@SpringBootTest(classes = {ReportApp.class, TestSecurityConfiguration.class})
public class AuxItemResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static AuxItem createUpdatedEntity(EntityManager em) {
        AuxItem auxItem = new AuxItem()
