...
import com.diviso.graeshoppe.report.repository.NotificationRepository;
import com.diviso.graeshoppe.report.repository.search.NotificationSearchRepository;
...
import com.diviso.graeshoppe.report.service.mapper.NotificationMapper;
...
public class NotificationResourceIntTest {
     ...
     *
     * @see com.diviso.graeshoppe.report.repository.search.NotificationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getImageLink()).isEqualTo(DEFAULT_IMAGE_LINK);
    ...
    public void updateNotification() throws Exception {
        ...
        assertThat(testNotification.getImageLink()).isEqualTo(UPDATED_IMAGE_LINK);
