...
export class OrderMasterComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.orderMasterService
                ...
                .subscribe(
                    (res: HttpResponse<IOrderMaster[]>) => this.paginateOrderMasters(res.body, res.headers),
    ...
    trackId(index: number, item: IOrderMaster) {
        return item.id;
    }

    registerChangeInOrderMasters() {
        this.eventSubscriber = this.eventManager.subscribe('orderMasterListModification', response => this.loadAll());
    }
    ...
    private paginateOrderMasters(data: IOrderMaster[], headers: HttpHeaders) {
