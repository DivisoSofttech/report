...
public class Status extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2156648380921018462L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Status\",\"namespace\":\"com.diviso.graeshoppe.order.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"name\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
   ...
   */
  public Status(java.lang.Long id, java.lang.String name) {
    this.id = id;
    this.name = name;
  }
...
@SuppressWarnings(value="unchecked")
   ...
   */
  public static com.diviso.graeshoppe.order.avro.Status.Builder newBuilder() {
    return new com.diviso.graeshoppe.order.avro.Status.Builder();
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static com.diviso.graeshoppe.order.avro.Status.Builder newBuilder(com.diviso.graeshoppe.order.avro.Status.Builder other) {
    return new com.diviso.graeshoppe.order.avro.Status.Builder(other);
  }
   ...
   * @return A new Status RecordBuilder
   */
  public static com.diviso.graeshoppe.order.avro.Status.Builder newBuilder(com.diviso.graeshoppe.order.avro.Status other) {
    return new com.diviso.graeshoppe.order.avro.Status.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Status>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.diviso.graeshoppe.order.avro.Status.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.diviso.graeshoppe.order.avro.Status other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.graeshoppe.order.avro.Status.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.graeshoppe.order.avro.Status.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.graeshoppe.order.avro.Status.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.diviso.graeshoppe.order.avro.Status.Builder clearName() {
      name = null;
