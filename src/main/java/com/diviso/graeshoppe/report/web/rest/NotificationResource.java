...
public class NotificationResource {
    ...
    private static final String ENTITY_NAME = "reportNotification";
    ...
    public ResponseEntity<NotificationDTO> createNotification(@RequestBody NotificationDTO notificationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/notifications/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert("report",true,ENTITY_NAME, result.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NotificationDTO> updateNotification(@RequestBody NotificationDTO notificationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("report", true,ENTITY_NAME, notificationDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Void> deleteNotification(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createEntityDeletionAlert("report",true,ENTITY_NAME, id.toString())).build();
    }
