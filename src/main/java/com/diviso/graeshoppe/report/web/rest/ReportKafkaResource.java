...
@RestController
@RequestMapping("/api/report-kafka")
public class ReportKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ReportKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ReportKafkaResource(KafkaProperties kafkaProperties) {
