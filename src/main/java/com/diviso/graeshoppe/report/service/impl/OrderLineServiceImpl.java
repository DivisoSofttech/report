...
public class OrderLineServiceImpl implements OrderLineService {
	...
	public OrderLineServiceImpl(OrderLineRepository orderLineRepository, OrderLineMapper orderLineMapper,
			OrderLineSearchRepository orderLineSearchRepository, OrderMasterRepository orderMasterRepository,
	...
	public List<OrderLine> findOrderLineByOrderNumber(String orderNumber) {
		...
		orderLines=orderLineRepository.findByOrderMaster(orderMaster.get().getId());
