...
public class OfferLineServiceImpl implements OfferLineService {
    ...
    public OfferLineServiceImpl(OfferLineRepository offerLineRepository, OfferLineMapper offerLineMapper, OfferLineSearchRepository offerLineSearchRepository) {
    ...
    public Page<OfferLineDTO> findAll(Pageable pageable) {
        ...
        return offerLineRepository.findAll(pageable)
    ...
    public Optional<OfferLineDTO> findOne(Long id) {
        ...
        return offerLineRepository.findById(id)
            .map(offerLineMapper::toDto);
    }
    ...
    public void delete(Long id) {
        log.debug("Request to delete OfferLine : {}", id);        offerLineRepository.deleteById(id);
